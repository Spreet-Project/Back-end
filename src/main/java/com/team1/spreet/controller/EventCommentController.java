...
public class EventCommentController {
    ...
    public CustomResponseBody<SuccessStatusCode> saveEventComment(@PathVariable @ApiParam(value = "댓글 등록할 행사 ID") Long eventId,
        ...
        return new CustomResponseBody<>(eventCommentService.saveEventComment(eventId, requestDto, Long.parseLong(userDetails.getUsername())));
    }
    ...
    public CustomResponseBody<SuccessStatusCode> updateEventComment(@PathVariable @ApiParam(value = "행사 댓글 ID") Long commentId,
                                                 ...
                                                 @AuthenticationPrincipal UserDetails userDetails){
        return new CustomResponseBody<>(eventCommentService.updateEventComment(commentId, requestDto, Long.parseLong(userDetails.getUsername())));
    }
    ...
    public CustomResponseBody<SuccessStatusCode> deleteEventComment(@PathVariable @ApiParam(value = "행사 댓글 ID") Long commentId,
                                                                    @AuthenticationPrincipal UserDetails userDetails){
        return new CustomResponseBody<>(eventCommentService.deleteEventComment(commentId, Long.parseLong(userDetails.getUsername())));
    }
