...
public class EmailController {
    ...
    public CustomResponseBody<SuccessStatusCode> sendEmail(@RequestParam @ApiParam(value = "이메일 주소") String email) throws Exception {
    ...
    public CustomResponseBody<SuccessStatusCode> emailConfirm(@RequestBody @ApiParam(value = "이메일 인증을 위한 정보") EmailDto emailDto) {
