...
public class AdminController {
	...
	public CustomResponseBody<SuccessStatusCode> approveCrew(@PathVariable @ApiParam(value = "크루 회원 승인을 위한 닉네임") String nickname) {
	...
	public CustomResponseBody<SuccessStatusCode> rejectCrew(@PathVariable @ApiParam(value = "크루 회원 거절을 위한 닉네임") String nickname) {
